class DoubleLinkedList:
    ...
    def insert(self, index: int, value) -> Node:
        ...
        if right is None: return self.push_back(value=value)

        left = right.prev
        if left is None: return self.push_front(value=value)
    ...
    def erase(self, index: int) -> Node:
        ...
        if node.prev is None: return self.pop_front()
        
        if node.next is None: return self.pop_back()
    ...
    def print_list(self) -> None:
        ...
        while current_node:
            print(current_node.value if current_node.value is not None else "_", end=" ")
    ...
    def __str__(self):
        ...
        result = ""
        while current_node:
            result += (current_node.value if current_node.value is not None else "_") + " "
            current_node = current_node.next
        return result
